<template>
  <div class="">
    <nav
      class="flex items-center justify-between px-2 pb-2 pt-2 md:py-4 container mx-auto max-w-7xl"
    >
      <!-- LOGO -->
      <nuxt-link
        to="/"
        class="block mt-4 lg:inline-block text-primary-600 lg:mt-0 mr-10 border-b-0 border-none"
      >
        <!-- <img src="~static/LogoBlack.svg" class="h-10 text-white" /> -->
      ...
      <div class="lg:hidden">
        ...
        >
          <div
            class="rounded-lg shadow-lg bg-woodsmoke-900 ring-1 ring-black ring-opacity-5 overflow-hidden"
          >
...
a.nuxt-link-exact-active {
  @apply text-primary-400 hover:text-primary-200 font-bold lg:border-b-2 border-primary-400 hover:border-primary-200 py-1;
}
</style>
