<template>
  <footer class="pt-8 pb-6">
    <div class="container mx-auto px-4 max-w-7xl">
      <div
        class="flex flex-wrap justify-center md:justify-between text-center lg:text-left mb-6 px-4 w-full"
      >
        <div class="flex justify-center sm:justify-start mb-4 md:mb-0 items-center">
          <a to="/" class="block">
            <img
              src="~static/LogoWhite.svg"
              alt="ProphetoLogoWhite"
              class="h-6 md:h-10"
            />
          </a>
        </div>
        <div class="flex-1 flex items-center justify-end">
          ...
          <a href="https://www.linkedin.com/in/daniel-mcdade/" target="_blank">
            <svg
